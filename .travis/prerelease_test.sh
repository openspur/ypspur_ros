...
generate_prerelease_script.py \
  ...
  --custom-repo \
    ypspur_ros__custom-2:git:https://github.com/openspur/ypspur_ros.git:${TRAVIS_PULL_REQUEST_BRANCH} \
    yp-spur__custom-2:git:https://github.com/openspur/yp-spur.git:master \
  --level 1 \
  --output-dir ./
